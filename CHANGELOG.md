...
### Changed
- **Base URL API**: Diperbarui ke domain Heroku `https://api-huashu-marketplace-e147ebd9bffa.herokuapp.com`.
...
### Changed
- **Base URL API**: Diperbarui ke domain ngrok baru `https://tetra-legal-regularly.ngrok-free.app`.
- **UI Cleanup**: Menghapus tombol Logout dari AppBar halaman Katalog. Logout tetap tersedia melalui menu Drawer navigasi.
